...
contract DeFiLendingTest is Test {
    ...
    function testBorrowAboveThreshold() public {
        ...
        vm.expectRevert(
            "Insufficient collateral. Your collateral: 100000000. Liquidation threshold: 75. The amount you asked to borrow was: 90000000. The maximum amount you can borrow is: 75000000"
        );
    ...
    function testLiquidation() public {
        ...
        vm.startPrank(user);
        vm.expectRevert(
            "Insufficient collateral. Your collateral: 100000000. Liquidation threshold: 75. The amount you asked to borrow was: 0. The maximum amount you can borrow is: 75000000"
        );
        lending.borrow(0);
        vm.stopPrank();
